...
module.exports = {
  dev: {
    ...
    proxyTable: {
      '/proxyApi': {
      //  target: 'http://mj.slzzyy.com:8080',//替换域名同时修改图标文字一善堂&nbsp;MJ，修改头顶文字
    ...
    port: 8779, // can be overwritten by process.env.PORT, if port is in use, a free one will be determined
