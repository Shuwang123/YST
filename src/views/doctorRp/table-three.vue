<template>
  <div>
    <el-table-column prop="" label="操作3" width="" header-align="center" align="center">
    ...
    <el-table-column prop="" header-align="center" :align="$store.state.common.align" label="数量" min-width="150">
      <template slot-scope="scope">
        ...
        <el-input-number ref="chd" v-model="scope.row.myNum" :step="1" @change="handleChange" :min="1" size="mini"></el-input-number>
