  ...
  <el-dialog
    ...
    <div style="width: 580px">
      <el-row>
        <el-col :span="12">
          ...
          <p>退单编号：<span v-text="registerAllData.Code"></span></p>
        </el-col>
        <el-col :span="12" style="text-align: right;padding-right: 10px">
          <p>退单时间：<span v-text="registerAllData.CreatedOnTime"></span></p>
        </el-col>
      </el-row>
      <!--header-->
      <el-row style="text-align: left;font-size: 20px;margin: 20px 0"><el-col :span="24"><b>{{registerAllData.StoreName}}退单笺</b></el-col></el-row>
      <el-row>
      ...
      <!--<el-row style="">-->
        <el-row style="height: 30px;line-height: 30px">
          <el-col :span="24">帖数：共 {{registerAllData.Total}} 剂，退单总价 ￥{{Number(registerAllData.TotalAmount).toFixed(2)}}</el-col>
        </el-row>
        <!--<el-col :span="12">-->
          <!--<el-row>-->
            <!--<el-col :span="24">-->
              <!--<span style="display: inline-block;width: 17%;vertical-align: top;">用法：</span>-->
              <!--&lt;!&ndash;<span style="display: inline-block;width: 81%;vertical-align: bottom;min-height: 20px;">先吃饭后吃药，加点水不放糖，水温50°，好好睡觉不要打游戏，不听的话你又要来看我</span>&ndash;&gt;-->
        ...
        <!--<el-col :span="10" :offset="2">-->
          <!--<el-row>-->
            ...
            <!--<el-col :span="24">-->
              ...
              <!--&lt;!&ndash;<span style="display: inline-block;width: 76%;vertical-align: bottom;min-height: 20px;">先吃饭后吃药，加点水不放糖，水温50°，好好睡觉不要打游戏，不听的话你又要来看我</span>&ndash;&gt;-->
      ...
      <div id="chenxiPrint" style="display: none">
        ...
        <table width="100%" style="font-size: 12px">
          ...
          <tbody>
          <tr>
            <td>退单编号：<span v-text="registerAllData.Code"></span></td>
            <td colspan="2" align="right">退单时间：<span v-text="registerAllData.CreatedOnTime"></span></td>
          </tr>
          <tr>
            <td height="50" style="font-size: 20px;margin: 20px 0"><b>{{registerAllData.StoreName}}的退单笺</b></td>
          </tr>
          <tr height="26">
          ...
          <tr>
            <td colspan="2" height="26">
              <div style="position: relative;margin-left: 36px">
                ...
                <p>共 {{registerAllData.Total}} 剂，退单总价 ￥{{Number(registerAllData.TotalAmount).toFixed(2)}}</p>
              </div>
            </td>
          </tr>
          <!--<tr valign="top">-->
    ...
    <div style="text-align: right">
      <span slot="footer" class="dialog-footer">
        <el-button type="primary" @click="chenxiPrint()">退单打印</el-button>
