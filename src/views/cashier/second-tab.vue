<template>
  <div class="storeStock-first-tab">
    <el-table
      ...
      <el-table-column prop="Code" header-align="right" align="right" label="挂号单" width="119"></el-table-column>
      <el-table-column header-align="left" align="left" label="时间" width="109">
