  ...
  mounted () {
    window.onresize = () => {
      ...
      if (this.windowWidth < 768) {
        this.switchSidebarCollapseHandle_0()
      } else {
        this.switchSidebarCollapseHandle_1()
      }
    }
  },
  methods: {
    ...mapMutations(['SWITCH_SIDEBAR_COLLAPSE', 'DELETE_CONTENT_TABS']),
    switchSidebarCollapseHandle_0 () {
      this.SWITCH_SIDEBAR_COLLAPSE({ collapse: true })
    },
    switchSidebarCollapseHandle_1 () {
      this.SWITCH_SIDEBAR_COLLAPSE({ collapse: false })
    }
  }
}
</script>
